...
async function checkAuthAndRedirect() {
    try {
        ...
        if (!window.location.pathname.includes('home.html')) window.location.href = `${getBasePath()}home.html`;
    } catch (error) {
        // User is not authenticated.
        const isLoginPage = window.location.pathname === getBasePath() || window.location.pathname === `${getBasePath()}index.html`;
        if (!isLoginPage && !window.location.pathname.includes('verify.html')) window.location.href = `${getBasePath()}index.html`;
    }
}
// Execute checkAuthAndRedirect on page load for all pages except verify.html
if (!window.location.pathname.includes('verify.html')) checkAuthAndRedirect();
...
if (window.location.pathname.endsWith('/') || window.location.pathname.endsWith('index.html')) {
    ...
    if (loginForm) loginForm.addEventListener('submit', async (e)=>{
        ...
        try {
            ...
            if (error.name === 'UserNotConfirmedException') {
                alert("Hesab\u0131n\u0131z do\u011Frulanmam\u0131\u015F. L\xfctfen e-postan\u0131z\u0131 do\u011Frulay\u0131n.");
    ...
    if (signupForm) signupForm.addEventListener('submit', async (e)=>{
        ...
        try {
            ...
            alert("Kay\u0131t ba\u015Far\u0131l\u0131! L\xfctfen e-postan\u0131za g\xf6nderilen do\u011Frulama linkine t\u0131klay\u0131n.");
            window.location.href = `${getBasePath()}verify.html?email=${encodeURIComponent(email)}`;
        } catch (error) {
...
if (window.location.pathname.includes('verify.html')) {
    ...
    if (resendCodeButton) resendCodeButton.addEventListener('click', async ()=>{
        ...
        try {
            ...
            alert("Do\u011Frulama kodu tekrar g\xf6nderildi.");
        } catch (error) {
...
if (window.location.pathname.includes('home.html')) {
    ...
    if (logoutButton) logoutButton.addEventListener('click', async ()=>{
        try {
            await signOut();
            alert("Ba\u015Far\u0131yla \xe7\u0131k\u0131\u015F yap\u0131ld\u0131.");
            window.location.href = `${getBasePath()}index.html`;
        } catch (error) {
            console.error("\xc7\u0131k\u0131\u015F yapma hatas\u0131:", error);
            alert(error.message);
        }
    });
}
...
if (window.location.pathname.includes('forgot-password.html')) {
    const { resetPassword, confirmResetPassword } = await require("94c3965f01f48f4e");
    ...
    sendCodeForm.addEventListener('submit', async (e)=>{
        ...
        try {
            ...
            alert("S\u0131f\u0131rlama kodu e-postana g\xf6nderildi.");
...
},{"94c3965f01f48f4e":"2PScl"}],"2PScl":[function(require,module,exports,__globalThis) {
module.exports = import("./auth.8a42d78f.js").then(()=>module.bundle.root('bLlRO'));

},{"bLlRO":"bLlRO"}]},["jWhgi","kTBnD"], "kTBnD", "parcelRequire2757", {})

//# sourceMappingURL=iyilik-zinciri.3c14d121.js.map
